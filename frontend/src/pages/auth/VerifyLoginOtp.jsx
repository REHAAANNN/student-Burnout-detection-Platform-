...
export const VerifyLoginOtp = () => {
  ...
  const { verifyLoginOtp, error: authError, clearError } = useAuth()
  ...
  const { values, errors, isSubmitting, handleChange, handleSubmit, setFieldError } = useForm(
    ...
    async (values) => {
      ...
      // Verify OTP
      await verifyLoginOtp(values.email, values.otp)
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Enter OTP to Login</p>
        </div>
        ...
        <Card className="shadow-lg-soft">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Login Verification</h2>
